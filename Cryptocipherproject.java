...
public class Cryptocipherproject {
    ...
    public static void main(String a[]){
        ...
        //Add label
        JLabel l1 = new JLabel("Hello Farhan welcome to Your crypt tool! ");
        JLabel l2 = new JLabel("Choose CIPHERING technique => ");
        l1.setBounds(200,5,300,20);
        l2.setBounds(200,15,300,40);
        l1.setVisible(true);
        f1.add(l1);
        f1.add(l2);
/*
 ...
 */
        ...
        b1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                tf.setVisible(true);
                //ADD ANSWER FIELD
                JLabel ansc = new JLabel("OUTPUT = ");
                ansc.setVisible(true);
                ansc.setBounds(50,100,100,20);
                fc.add(ansc);
